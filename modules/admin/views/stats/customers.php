    ...
    <div class="box-body">
        <table id="tableBasic" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
            <thead>
                <!-- Email -->
                <tr role="row">
                <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Email: activate to sort column descending" style="width: 200px;" aria-sort="ascending">Email</th>
                <!-- Name -->
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                        if ($client->offers == "1") echo '<span class="text-green"><b>Yes</b></span>';
                    ...
                    <a href="/admin/<?= $country->short ?>/stats/clientraport?clientId=<?= $client->id?>" target="_blank" class="btn btn-primary">Save as PDF</a>
                    </td>
                </tr>
                <?php endforeach ?>
                <?php } ?>
