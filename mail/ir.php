                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <td width="29" class="mobileOnTab"></td>
                            <td width="243">
                              ...
                              <img src="<?= $path ?>/imgs/clean.png" width="1" height="72" style="display:block; margin:0; padding:0; border:none;" class="mobileOffTab"/> 
                              <img src="<?= $path ?>/imgs/clean.png" width="1" height="42" style="display:block; margin:0; padding:0; border:none;" class="mobileOnTab"/> 
                    ...
                    <td style="text-align:center; display:inline" class="mobile">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" >
                        <tr height="40">
                          ...
                          <td class="mobileOnTab" width="74"><img src="<?= $path ?>/imgs/social-bg-2.jpg" width="74" height="40" style="display:block; margin:0; padding:0; border:none;"/></td>
                          ...
                          <td class="mobileOnTab" width="83"><img src="<?= $path ?>/imgs/social-bg-2.jpg" width="83" height="40" style="display:block; margin:0; padding:0; border:none;"/></td>
                        </tr>
                      </table>
                    </td>
                    </tr>
