                  ...
                  <tr bgcolor="#f2f2f2" style="height: 74px; vertical-align: text-top;">
                    ...
                    <td style="text-align:center; display:inline" class="mobile">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#060000">
                        <tr height="40">
                          <td><img src="<?= $path ?>/imgs/social-bg-2.jpg" width="219" height="40" style="display:block; margin:0; padding:0; border:none;"/></td>
                          ...
                          <td><img src="<?= $path ?>/imgs/social-bg-2.jpg" width="224" height="40" style="display:block; margin:0; padding:0; border:none;"/></td>
                        </tr>
                      </table>
                    </td>
                    </tr>
