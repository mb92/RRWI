...
<img src="http://www.google-analytics.com/collect?v=1&tid=<?= $tid ?>&cid=<?= $cid ?>&t=event&ec=email&ea=open&el=open_email&cs=newsletter&cm=email&cn=selfie-app" style="border-color:#525252; display:block; margin:0; padding:0; border:none;"/>
                  ...
                  <tr>
                    <td width="600" class="mobile" style="font-family:MyriadLight, Arial, Helvetica; font-size:12px; line-height:18px;">
                      <img src="<?= $path ?>/imgs/women-cw3.jpg" width="100%" height="auto" style="margin:0; padding:0; border:none; display:block;" border="0" class="imgClass" alt="" />
                    </td>
                  </tr>
                    ...
                    <td class="mobile"> 
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <font style="font-size:12px; color:#58595b;">
                            Entries are limited to strictly one Selfie Shot per person, per weekly competition.<br/>
                      ...
                      <td style="text-align:center; display:inline" class="mobile">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" >
                          <tr height="40">
                            ...
                            <td width="51">
                              <a href="<?= $links['twitter']; ?>"><img src="<?= $path ?>/imgs/icon_twitter-2.jpg" width="51" height="40" style="display:block; margin:0; padding:0; border:none;"/></a>
                            </td>
                            <td class="mobileOffTab">
